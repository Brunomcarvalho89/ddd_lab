...
Projeto AuthenticationIdentity é o projeto principal com api para cadastro de usurios e geração do token de acesso as funcionalidades.

Projeto EmailSender responsável por notificar via email.
